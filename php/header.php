...
<div id="login-box">
    ...
    <div id="login-box1" style="display:none;">
            <div id="state">
                <div id="closeA"><a href="#">X</a></div>
                <div>
                    <div id="main-tab-box">
                        <ul id="main-tab">
                            <li class="current"><a href="#login">登录</a></li>
                    ...
                    <div class="content reg-container" id="login" >
                        ...
                        <form class="form form-horizontal" id="form-loginA" action="#">
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="username">用户名:</label>
                                <div class="col-md-5">
                                    <input id="login-usernameA" type="text" name="uname" class="form-control" autofocus placeholder="请输入用户名" required pattern="^[a-zA-Z0-9]{8,16}$">
                                </div>
                                <label id="login-usernameATip" class="col-md-5 hide control-default">请输入8至16位的英文或数字</label>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label" for="password">密码:</label>
                                <div class="col-md-5">
                                    <input id="login-passwordA" type="password" name="upwd" class="form-control" placeholder="请输入密码" required pattern="^[a-zA-Z0-9]{6,12}$">
                                </div>
                                <label id="login-passwordATip" class="col-md-5 hide control-default">请输入6至12位的英文或数字</label>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" id="auto">下次自动登录
                                <a id="questionA">登录遇到问题</a>
                            </div>
                            <div class="form-group ">
                                <div class="col-md-5 ">
                                    <a  class="btn btn-success btn-block" id="login-btnA">登录</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="menu lf">
        ...
        <div class="top-nav">
            <ul class="hd">
                ...
                <li>
                    <a href="../account/products.html">
                        <span>Products</span>
                        <br>
                        蛋糕目录</a>
                </li>
                <li>
                    <a href="../happiness/happiness.html">
                        <span>Happiness</span>
                        <br>
                        述说幸福</a>
                </li>
                ...
                <li>
                    <a href="../vip/vip-home.html">
                        <span>Vipcake Home</span>
                        <br>
                        会员中心</a>
                        <ul class="list">
                            <li><a href="../vip/vip-home.html">会员活动</a></li>
                            <li><a href="../vip/vip-home2.html">会员申请</a></li>
                            <li><a href="../vip/vip-home3.html">会员特享DIY</a></li>
                        </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="top-right rt">
        <ul>
            <li class="topr">
                ...
                <a href="../personalCenter/center.html" id="login-btn1" class="hide active"></a>
                <a href="#" id="regist-btn">注册</a>
                <a href="#" class="hide" id="enter">[退出]</a>
                <a href="../personalCenter/centerOrder.html" id="my_order">我的订单</a>
                <a href="../account/payCart.html" class="none" id="none">购物车（<span id="number">0</span>）</a>
            </li>
            <li>
                <a href="../../administrator/index/index.html" id="J_Admin">管理员</a>
            </li>
            <li>
